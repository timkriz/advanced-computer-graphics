...
namespace PathTracer
{
    ...
    public class Scene
    {
        ...
        public static Scene CornellBox()
        {
            ...
            //disk light
            s.Elements.Add(new DiffuseAreaLight(new Disk(80, 0.1, Transform.Translate(278, 548, 280).A(Transform.RotateX(90))), Spectrum.Create(1), 25));

            //spherical light
            //el = new Sphere(50, Transform.Translate(400, 400, 280));
            //DiffuseAreaLight sphericalLight = new DiffuseAreaLight(el, Spectrum.Create(1), 15);
            //s.Elements.Add(sphericalLight);


            el = new Sphere(100, Transform.Translate(150, 100, 280));
            el.BSDF.Add(new Lambertian(Spectrum.ZeroSpectrum.FromRGB(Color.Blue)));
            //el.BSDF.Add(new OrenNayar(Spectrum.ZeroSpectrum.FromRGB(Color.Blue), 1));
            s.Elements.Add(el);
            ...
            //el.BSDF.Add(new OrenNayar(Spectrum.ZeroSpectrum.FromRGB(Color.Yellow), 1));
            s.Elements.Add(el);
